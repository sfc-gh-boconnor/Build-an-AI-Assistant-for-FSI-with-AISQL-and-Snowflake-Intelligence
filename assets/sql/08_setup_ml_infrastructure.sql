...
create stage if not exists ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.CSV_DATA_STAGE;

-- Create file format for CSV files
create or replace file format ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.CSV_FORMAT
    type = 'CSV'
    field_delimiter = ','
    record_delimiter = '\n'
    skip_header = 1
