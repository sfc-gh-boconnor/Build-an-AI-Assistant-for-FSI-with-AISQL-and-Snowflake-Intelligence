...
CREATE TABLE IF NOT EXISTS DEFAULT_SCHEMA.INFOGRAPHICS_FOR_SEARCH (
    TICKER VARCHAR,
...
CREATE VIEW IF NOT EXISTS DOCUMENT_AI.VW_FINANCIAL_SUMMARY AS
SELECT 
    'stub' AS COMPANY,
    'stub' AS TICKER,
    'stub' AS PERIOD,
...
CREATE VIEW IF NOT EXISTS DOCUMENT_AI.VW_INCOME_STATEMENT AS
SELECT 
    'stub' AS COMPANY,
    'stub' AS TICKER,
    'stub' AS PERIOD,
...
CREATE VIEW IF NOT EXISTS DOCUMENT_AI.VW_KPI_METRICS AS
SELECT 
    'stub' AS COMPANY,
    'stub' AS TICKER,
    'stub' AS PERIOD,
...
CREATE TABLE IF NOT EXISTS DEFAULT_SCHEMA.ANALYST_REPORTS (
    RELATIVE_PATH VARCHAR,
    URL VARCHAR,
    FILE_URL VARCHAR,
    RATING VARCHAR,
...
CREATE TABLE IF NOT EXISTS DEFAULT_SCHEMA.SENTIMENT_ANALYSIS (
    RELATIVE_PATH VARCHAR,
    SENTIMENT VARCHAR,
    OVERALL FLOAT,
    COST FLOAT,
...
CREATE TABLE IF NOT EXISTS DEFAULT_SCHEMA.TRANSCRIBED_EARNINGS_CALLS_WITH_SENTIMENT (
    RELATIVE_PATH VARCHAR,
    SPEAKER VARCHAR,
...
CREATE TABLE IF NOT EXISTS DEFAULT_SCHEMA.TRANSCRIPTS_BY_MINUTE (
    RELATIVE_PATH VARCHAR,
    SPEAKER VARCHAR,
    SPEAKER_NAME VARCHAR,
    MINUTES INTEGER,
...
DROP TABLE IF EXISTS DEFAULT_SCHEMA.INFOGRAPHICS_FOR_SEARCH;
DROP VIEW IF EXISTS DOCUMENT_AI.VW_FINANCIAL_SUMMARY;
DROP VIEW IF EXISTS DOCUMENT_AI.VW_INCOME_STATEMENT;
DROP VIEW IF EXISTS DOCUMENT_AI.VW_KPI_METRICS;
DROP TABLE IF EXISTS DEFAULT_SCHEMA.ANALYST_REPORTS;
DROP TABLE IF EXISTS DEFAULT_SCHEMA.SENTIMENT_ANALYSIS;
DROP TABLE IF EXISTS DEFAULT_SCHEMA.TRANSCRIBED_EARNINGS_CALLS_WITH_SENTIMENT;
DROP TABLE IF EXISTS DEFAULT_SCHEMA.TRANSCRIPTS_BY_MINUTE;
