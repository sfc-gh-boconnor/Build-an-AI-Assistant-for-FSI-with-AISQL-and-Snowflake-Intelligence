...
GRANT CREATE snowflake.ml.document_intelligence on schema ACCELERATE_AI_IN_FSI.DOCUMENT_AI to role ACCOUNTADMIN;
GRANT CREATE MODEL ON SCHEMA ACCELERATE_AI_IN_FSI.DOCUMENT_AI TO ROLE ACCOUNTADMIN;
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/analyst_reports/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/audio/
PATTERN = '.*\\.mp3';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/financial_reports/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/infographics/
PATTERN = '.*\\.png';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/investment_research/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/annual_reports/
FILES = (
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/executive_bios/
FILES = (
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/SNOW/
PATTERN = '.*';

-- NRNT
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/NRNT/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/NRNT/
PATTERN = '.*';

-- ICBG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/ICBG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/ICBG/
PATTERN = '.*';

-- QRYQ
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/QRYQ/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/QRYQ/
PATTERN = '.*';

-- DFLX
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/DFLX/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/DFLX/
PATTERN = '.*';

-- STRM
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/STRM/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/STRM/
PATTERN = '.*';

-- VLTA
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/VLTA/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/VLTA/
PATTERN = '.*';

-- CTLG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/CTLG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/CTLG/
PATTERN = '.*';

-- PROP
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/PROP/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/PROP/
PATTERN = '.*';

-- GAME
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/GAME/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/GAME/
PATTERN = '.*';

-- MKTG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/MKTG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/portraits/MKTG/
PATTERN = '.*';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/quickstart/assets/documents/social_media_images/
PATTERN = '.*';
