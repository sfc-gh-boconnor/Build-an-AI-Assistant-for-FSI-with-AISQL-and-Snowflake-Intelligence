...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/analyst_reports/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/audio/
PATTERN = '.*\\.mp3';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/financial_reports/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/infographics/
PATTERN = '.*\\.png';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/investment_research/
PATTERN = '.*\\.pdf';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/annual_reports/
FILES = (
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/executive_bios/
FILES = (
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/SNOW/
PATTERN = '.*';

-- NRNT
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/NRNT/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/NRNT/
PATTERN = '.*';

-- ICBG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/ICBG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/ICBG/
PATTERN = '.*';

-- QRYQ
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/QRYQ/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/QRYQ/
PATTERN = '.*';

-- DFLX
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/DFLX/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/DFLX/
PATTERN = '.*';

-- STRM
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/STRM/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/STRM/
PATTERN = '.*';

-- VLTA
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/VLTA/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/VLTA/
PATTERN = '.*';

-- CTLG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/CTLG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/CTLG/
PATTERN = '.*';

-- PROP
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/PROP/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/PROP/
PATTERN = '.*';

-- GAME
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/GAME/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/GAME/
PATTERN = '.*';

-- MKTG
COPY FILES
INTO @ACCELERATE_AI_IN_FSI.DOCUMENT_AI.EXECUTIVE_PORTRAITS/MKTG/
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/portraits/MKTG/
PATTERN = '.*';
...
FROM @SNOWFLAKE_QUICKSTART_REPOS.GIT_REPOS.ACCELERATE_AI_IN_FSI_REPO/branches/main/assets/documents/social_media_images/
PATTERN = '.*';
