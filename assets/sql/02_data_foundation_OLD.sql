...
-- =====================================================
-- NOTEBOOK 2 TABLES REMOVED
-- =====================================================
-- The following tables are generated by Notebook 2 (2_ANALYSE_SOUND.ipynb):
-- - TRANSCRIBED_EARNINGS_CALLS (AI_TRANSCRIBE output)
-- - SPEAKER_MAPPING (speaker identification)
-- - AI_TRANSCRIBE_NO_TIME (transcripts without timestamps)
-- - TRANSCRIBED_EARNINGS_CALLS_WITH_SENTIMENT (with AI_SENTIMENT)
-- - TRANSCRIPTS_BY_MINUTE (time-segmented transcripts)
-- - SENTIMENT_ANALYSIS (sentiment scoring)
-- These tables are now generated in the notebook for better educational value
-- =====================================================
...
-- Note: ANALYST_REPORTS_ALL_DATA removed - generate in notebook if needed
...
AS
    ...
    SELECT 
           ...
           NULL AS GROWTH,
           NULL AS NAME_OF_REPORT_PROVIDER,
           NULL AS DOCUMENT_TYPE,
           NULL AS DOCUMENT,
           NULL AS SUMMARY,
           NULL AS FULL_TEXT
    FROM DIRECTORY('@ACCELERATE_AI_IN_FSI.DOCUMENT_AI.ANALYST_REPORTS');
