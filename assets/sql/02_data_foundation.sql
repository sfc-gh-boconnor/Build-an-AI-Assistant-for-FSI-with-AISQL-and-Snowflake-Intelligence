...
GRANT SELECT ON TABLE ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.STOCK_PRICE_TIMESERIES TO ROLE ATTENDEE_ROLE;
GRANT SELECT ON TABLE ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.STOCK_PRICE_TIMESERIES TO ROLE PUBLIC;
GRANT SELECT ON TABLE ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.STOCK_PRICES TO ROLE ATTENDEE_ROLE;
...
GRANT USAGE ON PROCEDURE ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.SEND_EMAIL_NOTIFICATION(VARCHAR, VARCHAR, VARCHAR, VARCHAR) TO ROLE ATTENDEE_ROLE;
...
-- =====================================================
-- Moved to end - requires SNOWFLAKE_INTELLIGENCE_EXTERNALACCESS_INTEGRATION
...
SECRETS = ('snowflake_intelligence_api_key' = SNOWFLAKE_INTELLIGENCE_SECRETS.SNOWFLAKE_INTELLIGENCE_API_KEY)
AS '
import _snowflake
import requests
...
def search_web(query):
    """
    Performs a web search using Serper API and returns formatted results
    """
    try:
...
GRANT USAGE ON FUNCTION ACCELERATE_AI_IN_FSI.DEFAULT_SCHEMA.WEB_SEARCH(VARCHAR) TO ROLE ATTENDEE_ROLE;
